...
API surface · scheduled jobs · how live data flows · the AI architecture · data
sources · development setup · the F&O chart in depth · SEBI framing · changelog.
...
**[docs/PROMPTS.md](PROMPTS.md)** documents every LLM call in the project —
...
38 test files, 263 tests. Tests that read the DB assert the *shape* of a result,
